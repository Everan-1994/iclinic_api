...
class ServerController extends Controller
{
    public function index(Request $request)
    {
        ...
        return $this->success([
            'data' => ServerResource::collection($organization),
    ...
    public function show($id)
    {
        ...
        $organization = Server::query()->find($id);
    ...
    public function update($id, Request $request)
    {
        ...
        $organization = Server::query()->whereId($id)->update($params);
